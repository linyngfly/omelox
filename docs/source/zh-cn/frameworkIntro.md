...
Omelox的框架里还实现了request的filter机制，广播/组播机制，详细介绍见[omelox框架参考](https://github.com/linyngfly/omelox/wiki/Omelox-Framework)。
...
component在[omelox框架参考](https://github.com/linyngfly/omelox/wiki/Omelox-Framework)将有更深入的讨论。
以下是component的生命周期图：
