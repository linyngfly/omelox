...
[omelox] [修复win10 mqtt 超时问题](https://github.com/node-omelox/omelox/pull/137)


#### 1.4.9

[omelox-protobuf]: [在开启encode缓存时,优化protobuf encode性能. (提升1倍)](https://github.com/node-omelox/omelox/commit/721eda3437fdc1e704a426718776c72b073029d3)
```
...
[omelox]: [fixed bug:指定服务配置auto-restart失效](https://github.com/node-omelox/omelox/pull/132)   
 
[Example]:  [add nodejs ts client.](https://github.com/node-omelox/omelox/commit/bdcdc9bdbccdff6aeecfbfe8b18ec43f42228d76) 



#### 1.4.8

fix #128 https://github.com/node-omelox/omelox/issues/128  解决 mqtt-connection


#### 1.4.7

fix #129  https://github.com/node-omelox/omelox/issues/129
...
1. 更新 package.json,转移不需要的包到dev依赖. d58657d523c6ca1782dba1ec4c7d7d5cc62e5e22 https://github.com/node-omelox/omelox/issues/128
...
**omelox-protobuf** Encoder可选性能优化，添加Encoder缓存选项。
...
#### 1.4.1
try fix [#63](https://github.com/node-omelox/omelox/issues/65)  运行目录问题，先与pomelo的代码行为保持一致。
...
修复 因为修复  [#110](https://github.com/node-omelox/omelox/issues/110) 导致的 所有日志级别都变为INFO的问题。 
...
fix [#110](https://github.com/node-omelox/omelox/issues/110)  omelox-logger 的logger对象换成原始的 log4js 对象。

#### 1.3.14

fix [#104](https://github.com/node-omelox/omelox/issues/104)
