...
let a = "node dist/bin/omelox-gen-route.js gen -i testInterface -s test/serverProtos.json -c test/clientProtos.json -d test/dictionary.json"
...
test = main.parseToOmeloxProtobuf('./testInterface', '_Req', '_Res', true);
console.log('@@@server result', JSON.stringify(test, null, 4));
